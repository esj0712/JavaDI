...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		System.out.println("-primary=true : 클래스 중복시 사용하여 정상값 가져오기");
